      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        <div className="w-full md:w-48 shrink-0">
          <div className="relative aspect-square rounded-2xl overflow-hidden bg-slate-50 border border-slate-100 group-hover:shadow-lg transition-all duration-500">
            <img src={comment.productId?.image ? getImageUrl(comment.productId.image) : ''} alt={comment.productId?.title} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-700" />
