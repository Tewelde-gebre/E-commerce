                    ...
                    <label className="block">
                      ...
                      <div className="flex mt-2">
                        <select 
                          ...
                          onChange={handleInputChange}
                          className="px-3 md:px-4 py-4 shrink-0 rounded-l-2xl bg-slate-100 border border-slate-200 focus:outline-none font-bold text-slate-600 appearance-none cursor-pointer border-r-0"
                        >
                        ...
                        <input 
                          ...
                          type="number" 
                          placeholder="0.00" 
                          className="flex-1 min-w-0 px-4 md:px-6 py-4 rounded-r-2xl bg-slate-50 border border-slate-100 focus:outline-none focus:ring-2 focus:ring-orange-500/20 font-semibold text-slate-800 transition-all border-l-0" 
                        />
                      </div>
                    </label>
                    <label className="block">
